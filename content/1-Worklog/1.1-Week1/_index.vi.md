...
* Tạo tài khoản AWS Free Tier và tìm hiểu các khoản credit miễn phí
* Làm quen với AWS Management Console
* Học kiến thức cơ bản về AWS Billing, Cost Budgets và theo dõi chi phí

### Các công việc cần triển khai trong tuần này:
| Thứ | Công việc | Ngày bắt đầu | Ngày hoàn thành | Nguồn tài liệu |
| --- | --- | --- | --- | --- |
| 2 | - Tạo tài khoản AWS <br> - Hoàn thành 5 nhiệm vụ "Money-Making" <br> - Đọc danh sách "Credit Killer" <br> - Đọc các kiến trúc mẫu với 200$ <br> - Đọc về giám sát và tối ưu chi phí <br> - Khám phá AWS Console | 04/05/2026 | 04/05/2026 | <https://000001.awsstudygroup.com/vi/1-aws-free-tier-2025-revolution/> |
| 3 | - Học cách tạo Budget <br> - Học cách tạo Cost Budget <br> - Học cách tạo Usage Budget <br> - Học cách tạo RI Budget <br> - Học cách tạo Saving Plans Budget | 05/05/2026 | 05/05/2026 | <https://000007.awsstudygroup.com/vi/> |
...
* Tạo tài khoản AWS và nhận được credit free-tier
* Học các dịch vụ AWS cơ bản và cách sử dụng console
* Thiết lập Billing và báo cáo chi phí
...
**Kỹ năng đạt được:**
* Hiểu cách các dịch vụ AWS cốt lõi hoạt động phía sau
